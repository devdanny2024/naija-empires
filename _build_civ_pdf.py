...
SRC = pathlib.Path(r"D:\Work\naija-empires\Naija-Empires-Civilizations.md")
OUT = SRC.with_name("_tmp_civ.html")
...
"""
OUT.write_text(f"""<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Naija Empires — Civilizations</title><style>{CSS}</style></head><body><div class="brandbar"><span><b>Naija Empires</b> &nbsp;·&nbsp; Civilizations, Perks &amp; Bonuses</span><span>Design Reference</span></div>{html_body}</body></html>""", encoding="utf-8")
print(str(OUT))
